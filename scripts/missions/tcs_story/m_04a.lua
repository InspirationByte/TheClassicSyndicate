...
MISSION.Init = function()									-- Preparing Introduction
	...
	sounds:Precache( "wind.m_04a1" )
	sounds:Precache( "wind.m_04a2" )
	...
	gameHUD:ShowScreenMessage("#M_04_TITLE_CLEANUP", 3.5)				-- Classic title text (Duration)
...
function MISSION.SetupFlybyCutscene()
	...
	missionmanager:ScheduleEvent( function() 
		sounds:Emit( EmitParams.new("wind.m_04a1"), 0 )
	end, 2.4);
...
function MISSION.Phase1Start()
	...
	gameHUD:ShowScreenMessage("#M_04_OBJ_PICKUP", 3.5)
...
MISSION.UpdateAll = function(delta)
	...
	if missionmanager:IsTimedOut() then		-- If player time is out, then..
		...
		gameHUD:ShowScreenMessage("#M_04_OBJ_FAILED", 3.5)	--.. Display classic timeout text
