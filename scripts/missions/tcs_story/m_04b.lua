...
MISSION.Init = function()									-- Preparing Introduction
	...
	local playerCar = gameses:CreateCar("m_grandprix_ios", CAR_TYPE_NORMAL)	-- Create player car
	...
	gameHUD:ShowScreenMessage("#M_04_TITLE_CLEANUP_CNTD", 3.5)				-- Classic title text (Duration)
...
function MISSION.Phase1Start()
	...
	gameHUD:ShowScreenMessage("#M_04_OBJ_GETOUT", 3.5)
